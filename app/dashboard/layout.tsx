        ...
        <div className="min-h-screen bg-[#f8f9fc] flex">
            ...
            <aside className="w-64 bg-[#0a0e27] text-white flex flex-col fixed h-full z-10">
                ...
                <nav className="flex-1 overflow-y-auto px-4 space-y-6">
                    ...
                    {/* Feed Section */}
                    <div>
                        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 px-2">Feed</h3>
                        <div className="space-y-1">
                            <Link href="#" className="flex items-center justify-between px-2 py-1.5 text-gray-400 hover:text-white hover:bg-white/5 rounded-md text-sm transition-colors">
                                <span>Snoozed</span>
                            </Link>
                            <Link href="#" className="flex items-center justify-between px-2 py-1.5 text-gray-400 hover:text-white hover:bg-white/5 rounded-md text-sm transition-colors">
                                <span>Ignored</span>
