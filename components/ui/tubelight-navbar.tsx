...
export function NavBar({ items, className }: NavBarProps) {
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 bg-[#0f1629]/80 border border-white/10 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
                {items.map((item) => {
                            ...
                            {isActive && (
                                ...
                                >
                                    <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-1 bg-purple-500 rounded-t-full">
                                        ...
                                        <div className="absolute w-4 h-4 bg-purple-500/30 rounded-full blur-sm top-0 left-2" />
                                    </div>
                                </motion.div>
                            )}
                        </Link>
